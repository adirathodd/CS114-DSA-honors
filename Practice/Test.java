...
class Sorts {
public static <T extends Comparable<? super T>> void heapSort(T[]
array) {
}
public static <T extends Comparable<? super T>> void bubbleSort(T[]
array) {
T temp;
boolean sorted;
...
public static <T extends Comparable<? super T>> void insertSort(T[]
array) {
T temp;
int j;
...
public static <T extends Comparable<? super T>> void quickSort(T[]
array) {
quickSort(array, 0, array.length - 1);
}
private static <T extends Comparable<? super T>> void quickSort(T[]
